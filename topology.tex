...
\begin{dfn}
	A filtered diagram $ X \colon A \to \Top_{\cg} $ is said to be \defn{admissible} if and only if the following conditions obtain:
	\begin{itemize}
